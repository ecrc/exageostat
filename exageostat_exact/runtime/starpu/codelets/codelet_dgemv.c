        ...
        for (n = 0; n < A.nt; n++) {
                ...
                for(m = 0; m < A.mt; m++)
                {
                        ...
                        starpu_insert_task(starpu_mpi_codelet(cl),
                                        ...
                                        STARPU_R, RTBLKADDR(descA, sizeof(double)*A.mt, A.mt, n),
                                        STARPU_R, RTBLKADDR(descZ, sizeof(double)*tempnn, 0, n),
                                        STARPU_RW, RTBLKADDR(descZout, sizeof(double)*tempnn, 0, n),
