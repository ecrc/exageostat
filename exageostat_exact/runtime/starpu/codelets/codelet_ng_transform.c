...
static void CORE_ng_transform_starpu(void *buffers[], void *cl_arg) {
    int m, m0;
    double* z;
    double* theta;
    double flag = 0;
...
static struct starpu_codelet cl_ng_transform =
        {
                .where        = STARPU_CPU,
                .cpu_funcs    = {CORE_ng_transform_starpu},
                .nbuffers    = 2,
 ...
 *
 *  EXAGEOSTAT_ng_transform_Tile_Async - Transform the measurements vector inside the non-Gaussian MLE function.
...
int EXAGEOSTAT_ng_transform_Tile_Async(CHAM_desc_t *descZ, CHAM_desc_t *descflag, const double* theta,
    ...
    int tempmm;
    CHAM_desc_t Z = *descZ;
    struct starpu_codelet *cl = &cl_ng_transform;
    ...
    for (m = 0; m < Z.mt; m++) {
        ...
        starpu_insert_task(starpu_mpi_codelet(cl),
                           ...
                           STARPU_W, EXAGEOSTAT_RTBLKADDR(descflag, ChamRealDouble, 0, 0),
                //STARPU_VALUE, &flag, sizeof(int),
