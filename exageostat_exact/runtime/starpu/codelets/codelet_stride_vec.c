...
int EXAGEOSTAT_stride_vec_Tile_Async(CHAM_desc_t *descA, CHAM_desc_t *descB, CHAM_desc_t *descC,
    ...
    for (m = 0; m < A.mt; m++) {
        ...
        starpu_insert_task(starpu_mpi_codelet(cl),
                           ...
                           STARPU_W, EXAGEOSTAT_RTBLKADDR(descB, ChamRealDouble, (int) floor(m / 2.0), 0),
                           STARPU_W, EXAGEOSTAT_RTBLKADDR(descC, ChamRealDouble, (int) floor(m / 2.0), 0),
