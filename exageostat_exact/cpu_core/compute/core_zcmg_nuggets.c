 ...
 *
 ******************************************************************************/
void core_dcmg_nuggets(double* A, int m, int n, int m0, int n0, location *l1, location *l2, double* localtheta,
                       int distance_metric) {
        ...
        for (i = 0; i < m; i++) {
            ...
            for (j = 0; j < n; j++) {
                ...
                if (expr == 0)
                    ...
                    A[i + j * m] =
                            con * pow(expr, localtheta[2]) * gsl_sf_bessel_Knu(localtheta[2], expr); // Matern Function
                j0++;
            }
            i0++;
        }
 ...
 *
 ******************************************************************************/
void core_scmg_nuggets(float *A, int m, int n, int m0, int n0, location *l1, location *l2, double* localtheta,
                       int distance_metric) {
...
void core_sdcmg_nuggets(double* A, int m, int n, int m0, int n0, location *l1, location *l2, double* localtheta,
                        int distance_metric) {
