...
double HICMA_MLE_Tile(unsigned n, const double *theta, double *grad, void *data);
...
void HICMA_Call(MLE_data  *data, int ncores, int ts, int N, int nZobs, int nZmiss,  int gpus, int p_grid, int q_grid);
